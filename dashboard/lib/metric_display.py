...
METRIC_DEFINITIONS: dict[str, str] = {
    ...
    "EMERGENCE": "Positive kinetic emergence layer showing shape, power, or movement-gain pressure.",
    "INSTABILITY": "Release, extension, velocity, spin, or movement volatility layer.",
    "CONFIDENCE": "Sample-depth and signal-strength confidence layer for the current KDE read.",
