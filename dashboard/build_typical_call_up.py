...
def load_recent_arrivals(limit: int = 12) -> list[dict]:
  ...
  <div class="app">
    ...
    <section class="section arrivals-section">
      <div class="section-head">
        ...
        <div class="section-badge">AAA → MLB</div>
      </div>

      <div class="arrivals-grid">
        {% for row in recent_arrivals %}
...
def render_html(pitchers: pd.DataFrame, hitters: pd.DataFrame) -> str:
    ...
    recent_arrivals = load_recent_arrivals(limit=12)
