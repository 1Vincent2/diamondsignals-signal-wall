...
/* DESKTOP_ONLY_HEADER_VISUAL_ALIGNMENT_V1
   Desktop-only header normalization.
   Scope: report status/topbar row only.
   Do not touch mobile, Field Guide, player search, or shared nav. */
